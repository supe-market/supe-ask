...
class AskRoutesTests(unittest.TestCase):
    ...
    def test_run_event_stream_emits_snapshot_before_live_events(self):
        ...
        with self._client() as client, patch(
            ...
            side_effect=[running_run, running_run, running_run, completed_run],
        ), patch(
            "supe_ask.routes.api.repository.list_artifacts",
            ...
            return_value={"planningText": "Existing plan", "codeBuffer": "", "stdoutTail": [], "thinking": None, "updatedAt": "2026-04-13T10:00:00+00:00"},
        ), patch(
